...
-- 'yes' would prevents buffer moving when adding/deleting sign, but take space
...
-- Sane settings for nested languages
vim.api.nvim_create_autocmd("FileType", {
  pattern = {"html", "css", "javascript", "typescript", "javascriptreact", "typescriptreact", "json", "vue", "svelte"},
  callback = function()
...
-- search
vim.keymap.set("n", "j", "n", remap_opts)
vim.keymap.set("n", "J", "N", remap_opts)
